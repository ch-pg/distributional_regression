...
data_load <- read_excel('data/Folds5x2_pp.xlsx', sheet = 1)
...
quantile_funcs <- create_quantile_func_list(degree_i, num_knots_i, quantile_funcs = c("qnorm"))
...
# Plot out-of-sample coverage curves
...
generate_3d_plots(data, observation, predict_func, x_feature = 1, y_feature = 4, alpha = 0.3)